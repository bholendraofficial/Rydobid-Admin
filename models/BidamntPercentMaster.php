...
class BidamntPercentMaster extends \yii\db\ActiveRecord {

    public static function tableName() {
        return '{{%bidamnt_percent_master}}';
    }

    public function rules() {
        return [
            [['ryb_country_id', 'ryb_state_id', 'ryb_city_id', 'ryb_pincode_id', 'ryb_ride_type_id', 'ryb_conf_package_id', 'ryb_bid_amnt_percent_amt'], 'default', 'value' => null],
            [['ryb_country_id', 'ryb_state_id', 'ryb_city_id', 'ryb_pincode_id', 'ryb_ride_type_id', 'ryb_conf_package_id', 'ryb_bid_amnt_percent_amt'], 'integer'],
    ...
    public function attributeLabels() {
        return [
            'ryb_bidamnt_percent_id' => 'Ryb Bidamnt Percent ID',
            ...
            'ryb_bid_amnt_percent_amt' => 'Ryb Bid Amnt Percent Amt',
        ];
    }
