<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12">
                <?=
                $form->field($model, 'ryb_cm_privacy_policy_text')->textArea([
                    'class' => 'form-control html-editor', 'rows' => 10
                ])->label($model->getAttributeLabel('ryb_cm_privacy_policy_text'));
                ?>
            </div>

            <div class="col-md-12">
                <?=
                $form->field($model, 'ryb_cm_privacy_policy_file')->fileInput([
                    'class' => 'form-control', 'accept' => '.pdf'
                ])->label($model->getAttributeLabel('ryb_cm_privacy_policy_file'));
                ?>
                <a target="_blank" href="<?= $model->ryb_cm_privacy_policy_file; ?>">Click here to view the PDF File</a>
            </div>
