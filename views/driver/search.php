    ...
    <div class="card-body">
        <form method="GET" action="">
            <div class="row text-center cu-search_box">
                ...
                <div class="col-md-12">
                    <input type="number" class="form-control font-weight-bold cu-search_field" value="" placeholder="Enter Driver ID">
                </div>

                <div class="col-md-12 cu-search_btn-box">
                    <a href="<?= \yii\helpers\Url::to(["/driver/search-result"]); ?>" class="btn btn-primary cu-search_btn">
